...
//                                         FoodN Stuff Inventory Management
//                                     </span>
//                             </Link>
            ...
            <div className="row flex-nowrap">
                <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                    <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li className="w-100">
                                <Link to="/dashboard/item" className="nav-link px-0 align-middle text-white">
                                    <i className="bi-basket"></i>
                                    <span className="ms-2 d-none d-sm-inline">Manage Food Items</span>
                                </Link>
                            </li>
                            <li className="w-100">
                ...
                <div className="col p-0 m-0">
                    <div className="p-2 d-flex justify-content-center shadow">
                        <h4>Food Pantry Management System</h4>
                    </div>
                    <Outlet />
                </div>
            </div>
